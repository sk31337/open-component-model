...
Default templates for SAP open source repositories, including [LICENSE](LICENSE), [REUSE.toml](REUSE.toml), Code of Conduct, etc... All repositories on github.com/open-component-model will be created based on this template. Since the Open Component Model is mainly developed in Golang, there is a Go specific File [`.golangci.yaml`](.github/config/golangci.yaml) that can, but does not have to be removed after copy.
