...
| 8    | [`08_transfer_test.go`](08_transfer_test.go)       | **Transferring Components**  | Building transfer graphs, CTF-to-CTF transfer, transfer configuration, verifying transferred content |
