...
// ResourceDigestProcessorContract must be implemented by a plugin providing resource digest functionality. It's a REST
// wrapper interface around constructor.ResourceDigestProcessor.
